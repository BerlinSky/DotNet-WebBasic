...
export const ActivityForm: React.FC<IProps> = ({ setEditMode, activity: initalFormState }) => {  
  ...
  return (                                                                             
    <Segment clearing>                                                                 
      <Form onSubmit={handleSubmit}>                                                                           
        ...
        <Form.Input onChange={handleInputChange} name='date'  type='date' row={2} placeholder='Date' value={activity.date} />                          
